...
date: 2024-09-18T03:24:26.677Z
updated: 2024-09-24T00:33:09.294Z
tags:
  - cutting-edge
categories:
  - tech
thumbnail: https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/02/nicetochatgpt1.jpg
---
...
**Prompt: I'd appreciate it if you could list the major differences between Python and JavaScript.** 
                ...
                ![An excerpt from an answer given by ChatGPT to a Polite question about JavaScript And Python](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/01/screenshot-2024-01-08-at-17-39-28.png)
...
##  Did Being Polite Help?
 ...
 This is, of course, not conclusive, and it may only reflect the random element in how LLMs work. However, it also suggests that a small change in a prompt that asks essentially the same thing could have some effect on the result.

 Certainly, given how LLMs are trained, and the data used, it might reflect that asking for something nicely usually gets better results from humans, and that association might exist within the training data for LLMs.
...
##  There's No Downside to Being Polite
 ...
 As a rule, I try to be as polite to ChatGPT as I would to another human being. Not because I think I could hurt its nonexistent feeling, but simply because I don't want to be in a negative mindset.

 I don't want to get out of the habit of being polite, and working with AI like these every day might have the effect of dehumanizing us as users of technology. Being polite costs nothing, and being cold, rude, or even mean to a chatbot certainly does something to your state of mind and nothing to the unfeeling machine target of your ire.

 And hey, on the chance that one day the machines do eventually retain "memories" of our interactions with them, and it directly influences our experience, it certainly doesn't hurt to start a habit of being polite to them now.
